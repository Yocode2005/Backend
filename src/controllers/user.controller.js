...
const generateAccessAndRefereshTokens = async(userId) =>{
    try {
        ...
        user.refreshToken = refreshToken // store referesh token in db for the user
        await user.save({ validateBeforeSave: false })

        return {accessToken, refreshToken} // return esliye kyunki hume login controller me dono tokens bhejne hote hain
